...
import { Copy, FileDown, RefreshCw, Edit, Lock, Loader2 } from "lucide-react";
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-muted-foreground">Défense (48h)</span>
                <span>{countdown(dossier.deadline_defense) || "—"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Instruction (6 sem.)</span>
                <span>{countdown(dossier.deadline_instruction) || "—"}</span>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="space-y-2">
            ...
            {dossier.statut !== "clos" && (
              <Button variant="outline" className="w-full" onClick={closeDossier}>
